...
I enjoy building AI software and robots that automate work, so we can enjoy the fun stuff that life has to offer. My interests span robotics, AI/Ml, fintech, sustainability and entrepreneurship.
...
- **[DebateVault:](https://github.com/Raghavsk24/DebateVault)** High-Speed search engine indexing 600,000+ documents of competitive debate evidence retrieved from openCaseList Wiki. It also includes *[LD Debate Coach](https://chatgpt.com/g/g-v5BqfIh8h-ld-debate-coach)*: A custom GPT helping 800+ debaters with topic research and case writing.
